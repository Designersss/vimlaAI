...
export function loadApiConfig(
  ...
  return apiConfigSchema.parse({
    ...
    memoryDerivedAuditRetentionDays:
...
export function loadWorkerConfig(
  ...
  return workerConfigSchema.parse({
    ...
    billingSubscriptionPeriodDays: parsed.BILLING_SUBSCRIPTION_PERIOD_DAYS,
    aiDefaultMaxOutputTokens: parsed.AI_DEFAULT_MAX_OUTPUT_TOKENS,
    aiOutputShortPreferredTokens: parsed.AI_OUTPUT_SHORT_PREFERRED_TOKENS,
    aiOutputShortMinTokens: parsed.AI_OUTPUT_SHORT_MIN_TOKENS,
    aiOutputStandardPreferredTokens: parsed.AI_OUTPUT_STANDARD_PREFERRED_TOKENS,
    aiOutputStandardMinTokens: parsed.AI_OUTPUT_STANDARD_MIN_TOKENS,
    aiOutputLongPreferredTokens: parsed.AI_OUTPUT_LONG_PREFERRED_TOKENS,
