-- Allow durable orchestration backpressure states introduced by the AI billing safety gate.
-- These states are intentionally non-terminal and can resume after usage capacity changes.
